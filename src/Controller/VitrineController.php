...
class VitrineController extends AbstractController
{
    ...
    */
    ...
    public function show(Vitrine $vitrine, ManagerRegistry $doctrine, $id): Response
    {
        ...
        return $this->render('vitrine/show.html.twig', [
            ...
            'vitrine' => $vitrine,
            'url' => $this->generateUrl('app_vitrine_index', ['id' => $member->getId()]),
            'member' => $member,
        ]);
    }
       ...
       Montre $montre ): Response
   {
       if(! $vitrine->getMontres()->contains($montre)) {
           throw $this->createNotFoundException("Couldn't find such a watch in this vitrine!");
       }

       if(! $vitrine->isPublished()) {
